...
import { useState,useRef,useEffect,useMemo,useCallback,useReducer,useLayoutEffect ,useContext, useImperativeHandle,useTransition, memo} from 'react'
...
const PortalDom = ()=>{
  return ReactDOM.CreatePortal(<div>PortalDom</div>, document.body)
}
...
ReactDOM.createRoot(rootEl).render(<CreatePortal/ >);
